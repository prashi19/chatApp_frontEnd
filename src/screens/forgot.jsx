        ...
        return (
            <div class="Login">
                <center>
                    ...
                    <Inputs type={"Email"} className={"form-control"} id={this.state.Email} name={"Email"} placeholder={"Email"} value={this.state.Email} onChange={this.handleuserNameChange} />
                ...
                <Snackbar
                    ...
                    action={[
                        <div key="undo">
                            <Buttons label={"Undo"} color={"primary"} title={"close"} onClick={this.handleSnackClose} />
                        </div>
                    ]}
                />
            </div>
